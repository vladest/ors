...
QGeoCodingManagerEngineOrs::~QGeoCodingManagerEngineOrs()
{
}

QGeoCodeReply *QGeoCodingManagerEngineOrs::geocode(const QGeoAddress &address, const QGeoShape &bounds)
{
...
QGeoCodeReply *QGeoCodingManagerEngineOrs::geocode(const QString &address, int limit, int offset, const QGeoShape &bounds)
{
    ...
    QGeoCodeReplyOrs *geocodeReply = new QGeoCodeReplyOrs(reply, this);
...
QGeoCodeReply *QGeoCodingManagerEngineOrs::reverseGeocode(const QGeoCoordinate &coordinate,
...
void QGeoCodingManagerEngineOrs::replyFinished()
{
...
void QGeoCodingManagerEngineOrs::replyError(QGeoCodeReply::Error errorCode, const QString &errorString)
{
    QGeoCodeReply *reply = qobject_cast<QGeoCodeReply *>(sender());
    if (reply)
