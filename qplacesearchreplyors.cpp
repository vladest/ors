...
QPlaceSearchReplyOrs::QPlaceSearchReplyOrs(const QPlaceSearchRequest &request,
                                             QNetworkReply *reply, QPlaceManagerEngineOrs *parent)
...
QPlaceSearchReplyOrs::~QPlaceSearchReplyOrs()
{
}

void QPlaceSearchReplyOrs::abort()
{
    if (m_reply)
        m_reply->abort();
}

void QPlaceSearchReplyOrs::setError(QPlaceReply::Error errorCode, const QString &errorString)
{
...
void QPlaceSearchReplyOrs::replyFinished()
{
...
QPlaceResult QPlaceSearchReplyOrs::parsePlaceResult(const QJsonObject &item) const
{
    QPlace place;
