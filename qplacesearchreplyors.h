...
#ifndef QPLACESEARCHREPLYORS_H
#define QPLACESEARCHREPLYORS_H
...
class QNetworkReply;
class QPlaceManagerEngineOrs;
class QPlaceResult;

class QPlaceSearchReplyOrs : public QPlaceSearchReply
{
    Q_OBJECT

public:
    QPlaceSearchReplyOrs(const QPlaceSearchRequest &request, QNetworkReply *reply,
                          QPlaceManagerEngineOrs *parent);
    ~QPlaceSearchReplyOrs();
